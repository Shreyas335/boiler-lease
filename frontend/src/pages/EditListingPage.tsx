...
export default function EditListingPage() {
  ...
  function validateForm(): boolean {
    ...
    if (!form.street_line_1.trim())
      nextErrors.street_line_1 = "Street address is required.";
              ...
              <Grid container spacing={2}>
                <Grid size={{ xs: 12, md: 6 }}>
                  <TextField
                    ...
                    onChange={(e) =>
                      handleChange("street_line_1", e.target.value)
                    }
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <TextField
                    ...
                    onChange={(e) =>
                      handleChange("street_line_2", e.target.value)
                    }
                  />
                </Grid>
                <Grid size={{ xs: 12, md: 3 }}>
                ...
                <Grid size={{ xs: 12, md: 4 }}>
                  <TextField
                    ...
                    onChange={(e) =>
                      handleChange("virtual_tour_url", e.target.value)
                    }
                  />
                </Grid>
              </Grid>
