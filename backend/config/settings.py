...
# Platform fee on booking rent subtotal (percent of prorated base rent shown in price breakdown).
PLATFORM_BOOKING_FEE_PERCENT = Decimal(os.environ.get("PLATFORM_BOOKING_FEE_PERCENT", "3.00"))
